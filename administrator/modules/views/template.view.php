...
<head>
    ...
    <title>Lembaga Adat Melayu Administrator</title>
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">Lembaga Adat Melayu Administrator</a>
        </div>
        <!-- Top Menu Items -->
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li <?php if($page=="Tentang") echo 'class="active"'; ?>>
                    <a href="<?php echo PATH; ?>?page=Tentang"><i class="fa fa-fw fa-building"></i> Tentang LAM Kepri</a>
                </li>
